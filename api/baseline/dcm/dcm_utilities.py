...
from api.baseline.dsm.utilities import get_optimizer
...
def train_step(model, x, t, e, breslow_splines, optimizer, bs=256, seed=100, typ='soft',
               use_posteriors=False, update_splines_after=10, smoothing_factor=1e-4):
